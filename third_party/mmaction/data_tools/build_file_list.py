...
def parse_args():
    ...
    parser.add_argument('--dataset_path', type=str, help='path to the self-made dataset')
...
def main():
    ...
    if args.dataset == 'ucf101':
        ...
        # Support any dataset generated with scripts
        split_tp = parse_other_dataset_splits(args.level, args.dataset_path)
